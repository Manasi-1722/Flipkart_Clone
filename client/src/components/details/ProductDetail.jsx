...
const ProductDetail = ({ product }) => {
    ...
    return (
        <>
            ...
            <Smalltext>
                <Typography><StyledBadge />Get extra 20% off upto ₹50 in 1 item(s) T&C </Typography>
                ...
                <Typography><StyledBadge />No Cose EMI on Bajaj Finserv EMI Card on cart value above ₹2999 T&C </Typography>
            </Smalltext>
